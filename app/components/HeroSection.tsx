          ...
          <div className="lg:col-span-5 text-center lg:text-left space-y-8 lg:space-y-10">
            ...
            <div className="grid grid-cols-3 gap-6 lg:gap-8 pt-4">
              <div>
                ...
                <div className="text-xs text-gray-600 mt-1">{t('hero.stats.calcs')}</div>
              </div>
              <div>
                <div className="text-3xl lg:text-4xl font-bold text-gray-900">1000+</div>
                <div className="text-xs text-gray-600 mt-1">{t('hero.stats.materials')}</div>
              </div>
              <div>
                <div className="text-3xl lg:text-4xl font-bold text-gray-900">95%</div>
                <div className="text-xs text-gray-600 mt-1">{t('hero.stats.accuracy')}</div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 relative lg:pl-12 xl:pl-16 lg:-mt-8">
            <div className="relative z-10 glass rounded-2xl p-6 shadow-2xl max-w-md lg:max-w-lg xl:max-w-xl lg:ml-8 xl:ml-12">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-base font-semibold text-gray-900">{t('hero.mockup.title')}</h3>
                  <span className="px-2.5 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium">
                    {t('hero.mockup.active')}
                  </span>
                </div>
                ...
                <div className="space-y-3">
                  <div className="bg-white rounded-lg p-4 shadow-sm">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-xs text-gray-600">{t('hero.mockup.area')}</span>
                  ...
                  <div className="bg-white rounded-lg p-4 shadow-sm">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-xs text-gray-600">{t('hero.mockup.budget')}</span>
                  ...
                  <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg p-4 text-white">
                    <div className="text-xs opacity-90 mb-1">{t('hero.mockup.total')}</div>
                    <div className="text-2xl font-bold">127 450 с</div>
                    <div className="text-xs opacity-75 mt-1">{t('hero.mockup.savings')}: 22 550 с</div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-white rounded-lg p-3 shadow-sm">
                    ...
                    <div className="text-xs text-gray-600">{t('hero.mockup.paint')}</div>
                    <div className="text-sm font-semibold text-gray-900">12 л</div>
                  </div>
                  <div className="bg-white rounded-lg p-3 shadow-sm">
                    <div className="text-2xl mb-1">🧱</div>
                    <div className="text-xs text-gray-600">{t('hero.mockup.tile')}</div>
                    <div className="text-sm font-semibold text-gray-900">48 м²</div>
                  </div>
                  <div className="bg-white rounded-lg p-3 shadow-sm">
                    <div className="text-2xl mb-1">📐</div>
                    <div className="text-xs text-gray-600">{t('hero.mockup.laminate')}</div>
                    <div className="text-sm font-semibold text-gray-900">50 м²</div>
                  </div>
                  <div className="bg-white rounded-lg p-3 shadow-sm">
                    <div className="text-2xl mb-1">🖼️</div>
                    <div className="text-xs text-gray-600">{t('hero.mockup.wallpaper')}</div>
                    <div className="text-sm font-semibold text-gray-900">8 {t('hero.mockup.rolls')}</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -top-6 -right-6 glass rounded-xl p-3 shadow-xl animate-float hidden lg:block">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <div className="text-xs text-gray-600 whitespace-nowrap">{t('hero.mockup.compatibility')}</div>
                  <div className="text-sm font-semibold text-gray-900">{t('hero.mockup.verified')}</div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -bottom-6 left-0 glass rounded-xl p-3 shadow-xl animate-float hidden lg:block" style={{ animationDelay: '1s' }}>
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <div className="text-xs text-gray-600 whitespace-nowrap">{t('hero.mockup.recommendations')}</div>
                  <div className="text-sm font-semibold text-gray-900">{t('hero.mockup.ready')}</div>
                </div>
              </div>
            </div>
          </div>
