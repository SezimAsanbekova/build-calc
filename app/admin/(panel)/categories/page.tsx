      ...
      {() => (
        <div className="space-y-6">
          ...
          <div className="bg-slate-800/40 border border-slate-700 rounded-2xl p-16 text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Категории не добавлены</h3>
            <p className="text-slate-400 text-sm mb-6">Создайте первую категорию материалов</p>
