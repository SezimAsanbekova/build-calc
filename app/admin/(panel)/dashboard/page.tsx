      ...
      <div className="bg-slate-800/50 border-b border-slate-700 sticky top-0 z-20 backdrop-blur-sm">
        <div className="h-16 px-6 lg:px-8 flex items-center justify-between">
          <div className="pl-12 lg:pl-0 flex items-baseline gap-3 min-w-0">
            <h1 className="text-base font-bold text-white whitespace-nowrap">Dashboard</h1>
            <span className="text-sm text-slate-400 truncate hidden sm:inline">
              Обзор системы BuildCalc AI
            </span>
          </div>
          <div className="flex items-center space-x-2 flex-shrink-0">
            <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse" />
            <span className="text-xs text-slate-400 hidden sm:inline">Система работает</span>
          </div>
        </div>
      </div>
